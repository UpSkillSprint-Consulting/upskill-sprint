(function () {
  ...
  function addStyles() {
    ...
    style.textContent = `
      ...
      html[data-theme="dark"] .upskill-spec-selector select,html[data-theme="dark"] .upskill-spec-selector input[type="text"]{background-color:var(--surface,var(--card,#111c2d))!important;color:var(--ink,#f4f7fb)!important}
      html[data-theme="dark"] .upskill-spec-selector option{background:#111c2d!important;color:#f4f7fb!important}
      @media(max-width:920px){.upskill-spec-selector-grid{grid-template-columns:1fr}}
    `;
  ...
  function enhanceField(label, index) {
    ...
    wrapper.append(grid, custom, summary);
    ...
    // Import routines may assign input.value without dispatching an event.

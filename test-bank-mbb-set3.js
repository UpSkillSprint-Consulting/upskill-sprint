(function(global){
  ...
  },
  {
    ...
    "options": [
      ...
      "Coach both champions to present capacity, dependencies and shared priority criteria jointly; facilitate a recommendation and route unresolved allocation decisions to the council."
    ],
    "answer": 3,
  ...
  },
  {
    ...
    "options": [
      ...
      "Use observed examples to coach listening and facilitation; help the Belt repair operator engagement, review data-coverage risks, and verify improvement in later sessions.",
  ...
  },
  {
    ...
    "options": [
      ...
      "Check the analysis and its limitations, then present the evidence honestly with a proposed next test; offer MBB support and escalate if pressure to misrepresent emerges.",
  ...
  },
  {
    ...
    "options": [
      ...
      "Acknowledge the concern, review specific demonstrated competencies against the internal criteria, identify remaining evidence or development needs, and agree a supported next step.",
  ...
  },
  {
    ...
    "options": [
      ...
      "Start with the mentee's current goal and questions, use relevant experience selectively, and finish with a mentee-owned action and a later application check.",
  ...
  },
  {
    ...
    "options": [
      ...
      "It is unacceptable under the adopted guideline: study variation is about 46.9%; investigate the error components, improve the system and verify adequacy before relying on capability.",
  ...
  },
  {
    ...
    "options": [
      ...
      "Kappa is 0.40 and observed agreement is 70%; the screen is not met. Review disagreements and validate against reference classifications before claiming inspection accuracy.",
  ...
  },
  {
    ...
    "options": [
      ...
      "Cpk = 0.92; the upper specification is nearer and the point estimate misses 1.33. Capability below target does not mean the process is unstable.",
  ...
  },
  {
    ...
    "options": [
      ...
      "Investigate subgroup 6's range signal and assess affected output. Do not claim overall stability or automatically recalculate the valid historical limits from this new signal.",
  ...
  },
  {
    ...
    "options": [
      "The three observations exceed the 7.65-day upper fence. Check records, timing and claim mix; a boxplot flag alone proves neither bad data nor an SPC special cause.",
  ...
  },
  {
    ...
    "options": [
      ...
      "Check the two low results and their lot/time context, retaining valid observations; the pattern questions a single normal model but does not establish a specific cause.",
  ...
  },
  {
    ...
    "options": [
      "The observed biases are +2 mm at all three levels. Evaluate a constant-offset correction and validate it across the intended range; the means alone do not prove zero linearity error.",
  ...
  },
  {
    ...
    "options": [
      ...
      "Add 1.5 to the reported Cpk to offset the non-normality and retain the report's predicted normal-tail rate.",
    ...
    "optionRationales": [
      ...
      "Incorrect. Adding a constant to Cpk has no basis for correcting distributional shape or tail risk.",
  ...
  },
  {
    ...
    "options": [
      "The configured eight-point rule signals at point 48; investigate a possible upward shift while retaining the baseline limits unless a justified change supports rebaselining.",
  ...
  },
  {
    ...
    "options": [
      ...
      "Retain limits appropriate to subgroup means for stability monitoring and use specifications for unit conformance; equal numerical values must not be imposed, although they can coincide.",
  ...
  },
  {
    ...
    "options": [
      ...
      "At the two designated quality levels, A has lower producer and consumer risks than B; its sharper transition costs a larger sample, and slope alone would not establish both risks.",

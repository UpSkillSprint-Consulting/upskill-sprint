...
Segments 09–13 are now human-merged through PRs #176–#179. Segment 14 starts from exact `main` commit `c41e7b95f3b4abc5df3ceb8977de9b48f70fb618` and keeps their grading, metrics, history/version, durability, lifecycle and authoritative-timing contracts intact. See [Segment 14 incremental synchronization](SEGMENT-14-INCREMENTAL-SYNC.md). Its server-sequence migration must be deployed before the Segment 14 frontend policy; cross-device takeover remains Segment 15 and does not start automatically.

...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '  width: 280px; max-width: calc(100vw - 32px); box-sizing: border-box; padding: 8px; z-index: 80;',
      ...
      '.account-menu-panel [data-account-access] { word-break: normal; overflow-wrap: normal; }',

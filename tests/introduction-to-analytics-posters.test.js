...
// Regression guard for the Introduction to Analytics wall posters.
//
// The lesson ships four downloadable "wall poster" PDFs. They were once
// committed as ~1.7 KB placeholder stubs, which meant the download/open
// links resolved to empty documents. This test would have caught that:
// it verifies every poster the HTML links to actually exists on disk, is a
...
const LESSON = path.join(ROOT, 'lessons', 'data-analytics', 'introduction-to-analytics.html');
const DOWNLOAD_PREFIX = '/downloads/introduction-to-analytics/';

// A genuine full-resolution poster is well over 100 KB; the old placeholder
// stubs were ~1.7 KB. 100 KB cleanly separates the two.

...
test('Batch 4 independently byte-locks all Q1–75 and Q101–175 plus all identities',()=>{
 ...
 assert.equal(sha(source.slice(0,starts[75])),'8eba5c0654013cbc23f17a532cef4553de701fe0b07d02a73247cfbdb05225a0');assert.equal(sha(source.slice(starts[100])),'5cb7bbdfb92e4d9e2f482356dc64c60371380e9f66d42093ad7f6827b9f63750');assert.equal(new Set(bank.map(q=>q.qid)).size,175);
});

...
'<section id="spx-tab-reference-diagrams" class="spx-panel" role="tabpanel" data-panel="reference-diagrams" hidden>',
  ...
  '<div class="spx-card spx-card-pad">',
    '<div class="spx-card-title">',
      ...
      '<p id="spx-r5-subtitle">Illustrative dominant product after an assumed sufficient isothermal hold; transformation time is not calculated.</p></div>',
    ...
    '<div class="spx-checks">',
      ...
      '<label><input id="spx-r5-labels" type="checkbox" checked> Overlay labels</label>',
    ...
    '<div class="spx-svg-wrap spx-r5-wrap" id="spx-r5-svg-wrap" role="region" aria-label="Scrollable steel phase map" tabindex="0">',
      '<svg id="spx-r5-svg" viewBox="0 0 1000 1120" role="group" ',
  ...
  '<div class="spx-r5-stack">',
    '<div class="spx-card spx-card-pad">',
      ...
      '<div class="spx-points" id="spx-r5-points-list"></div>',
    '</div>',

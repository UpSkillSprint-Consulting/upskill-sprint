(function () {
  ...
  var FORMULAS = [
    ...
    f('oee', ['ci', 'ppc'], 'Overall equipment effectiveness',
      ...
      'Use when the three OEE factors are supplied or can be calculated.',
      ...
      [/overall equipment effectiveness|\bOEE\b|availability.*performance.*quality/i], ['equipment effectiveness']),
    ...
    f('exponential', ['quant', 'risk'], 'Exponential reliability and failure time',
      ...
      [/exponential distribution|constant failure rate|constant hazard|memoryless|mission reliability/i], ['exponential life']),

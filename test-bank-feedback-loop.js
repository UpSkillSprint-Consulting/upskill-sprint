(function () {
  ...
  function auditedEvidence(question) {
    const ui = window.__MBBFinalAuditUI && window.__MBBFinalAuditUI.isQuestion(question) ? window.__MBBFinalAuditUI : window.__MBBBatch5UI && window.__MBBBatch5UI.isQuestion(question) ? window.__MBBBatch5UI : window.__MBBBatch3UI && window.__MBBBatch3UI.isQuestion(question) ? window.__MBBBatch3UI : window.__MBBBatch4UI && window.__MBBBatch4UI.isQuestion(question) ? window.__MBBBatch4UI : window.__MBBBatch2UI;
